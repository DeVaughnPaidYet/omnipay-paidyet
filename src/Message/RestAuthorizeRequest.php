 ...
 * credit card details and you intend to use the PaidYET REST gateway
 * for processing a transaction using that credit card data.
 *
 * This does not require the customer to have a PaidYET account.
 *
 * </code>
 ...
 * and in the USA.
 *
 * #### PaidYET Account Authorization
 *
 * This is for the use case where the customer intends to pay using their
 * PaidYET account.  Note that no credit card details are provided, instead
 ...
 * being returned or cancelled by PaidYET.
 *
 ...
 *       // Redirect the customer to PaidYET so that they can sign in and
